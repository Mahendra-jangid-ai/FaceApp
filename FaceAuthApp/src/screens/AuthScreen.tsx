...
const s = StyleSheet.create({
  ...
  distanceNum: { fontSize: 32, fontWeight: '800', color: colors.danger, fontFamily: MONO },
  distanceLabel: { fontSize: 12, color: colors.textDim, marginTop: 2 },
  ...
  zoneInfoTitle: { fontSize: 12, fontWeight: '700', color: colors.accent },
  zoneInfoSite: { fontSize: 14, fontWeight: '700', color: colors.text, marginTop: 2 },
  zoneInfoRadius: { fontSize: 12, color: colors.textDim, marginTop: 4 },
  ...
  directionLabel: { fontSize: 11, fontWeight: '700', color: colors.textFaint, textTransform: 'uppercase' },
  directionArrow: { fontSize: 36, color: colors.accent, marginVertical: 2 },
  directionName: { fontSize: 14, fontWeight: '700', color: colors.text },
  directionNeed: { fontSize: 12, color: colors.danger, marginTop: 2, fontWeight: '600' },
